...
//Aprovechando que el primer 1/4 del display tiene otros colores
void display_header()
{
	oled_clearScreen(OLED_COLOR_BLACK);
	oled_putString(2, 2, (uint8_t *)"Escudero, Maero", OLED_COLOR_WHITE, OLED_COLOR_BLACK);
...
//DEBUG: Muestra el valor de los tres ejes, un eje por renglon y debajo el valor de G^2
...
//Muestra en el segundo renglon del display el string provisto
